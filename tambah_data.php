            ...
            <div class="col-md-6">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="jenis_buku" id="jenis_buku" placeholder="jenis buku" autocomplete="off">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Penulis</label>
                        <input type="text" class="form-control" name="penulis" id="penulis" placeholder="nama penulis" autocomplete="off">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="tahun_terbit" id="tahun_terbit" placeholder="tahun terbit" autocomplete="off">
                    </div>    
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="no_isbn" id="no_isbn" placeholder="no isbn" autocomplete="off">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Jumlah Halaman</label>
                        <input type="number" class="form-control" name="jml_hal" id="jml_hal" placeholder="jumlah halaman" autocomplete="off">
                    </div>
                    <div class="mb-3">
